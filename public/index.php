        ...
        <div style='background: white; color: #333; padding: 3rem; border-radius: 20px; margin-bottom: 3rem; text-align: center; box-shadow: 0 15px 50px rgba(0,0,0,0.2);'>
            <div style='display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; align-items: center;'>
                <div style='text-align: left;'>
                    ...
                    <p style='font-size: 1.3rem; margin-bottom: 1rem;'>06 de março às 20h</p>
                ...
                <div>
                    <img src='Imagens/f1b45508-b7cd-4f0f-8ef6-235b867a62ad.jfif' style='width: 100%; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.3);' alt='Baile Dançante'>
                </div>
            </div>
        </div>
