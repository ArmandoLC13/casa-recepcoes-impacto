        ...
        <div style='background: white; color: #333; padding: 3rem; border-radius: 20px; margin-bottom: 3rem; text-align: center; box-shadow: 0 15px 50px rgba(0,0,0,0.2);'>
            <div style='display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; align-items: center;'>
                <div style='text-align: left;'>
                    ...
                    <h4 style='font-size: 2rem; margin-bottom: 2rem; color: #28a745;'>BANDA FASCINAÇÃO</h4>
                    <p style='font-size: 1.3rem; margin-bottom: 1rem;'><strong>DATA:</strong> 06/02</p>
                    <p style='font-size: 1.3rem; margin-bottom: 1rem;'><strong>HORÁRIO:</strong> 20h</p>
                    <p style='font-size: 1.2rem; margin-bottom: 1.5rem; background: rgba(40,167,69,0.1); padding: 1rem; border-radius: 10px; color: #28a745; font-weight: bold;'>Preço com desconto até dia 20/01</p>
                ...
                <div>
                    <img src='Imagens/130a8ac0-058b-4337-bf12-7f684d13db51.jfif' style='width: 100%; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.3);' alt='Baile Dançante'>
                </div>
            </div>
        </div>
